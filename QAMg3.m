...
AmI = 0.265;                                         % amplitude level corresponding to phi1
AmQ = 0.265;                                         % amplitude level corresponding to phi2
L=1500;
...
w=0.75*cos(2*pi*fc*t + pi/4) + 0.75*sin(2*pi*fc*t + pi/4);                        % carrier waveform
